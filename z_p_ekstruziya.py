...
def zpekstruziya():
    ...
    with col370:
        ...
        wa1 = float('{:.3f}'.format(wa1))
        ua1 = float('{:.3f}'.format(ua1))
        ya1 = float('{:.3f}'.format(ya1))
        va1 = float('{:.3f}'.format(va1))
        xa1 = float('{:.3f}'.format(xa1))
        ta1 = float('{:.3f}'.format(ta1))
        ...
        wb1 = float('{:.3f}'.format(wb1))
        ub1 = float('{:.3f}'.format(ub1))
        yb1 = float('{:.3f}'.format(yb1))
        vb1 = float('{:.3f}'.format(vb1))
        xb1 = float('{:.3f}'.format(xb1))
        tb1 = float('{:.3f}'.format(tb1))
