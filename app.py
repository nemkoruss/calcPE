...
y = st.sidebar.selectbox('РАСЧЁТ ЗАКАЗА:', ['Выбрать','Заказ на бахилы','Заказ на пленку', 'Заказ на пакеты','Заказ на перчатки', 'Очистить экран'])
...
z = st.sidebar.selectbox('РАСЧЁТ ВЫПЛАТ:', ['Выбрать','Цех бахил','Цех экструзии', 'Цех перчаток','Цех пакетов', 'Очистить экран'])
