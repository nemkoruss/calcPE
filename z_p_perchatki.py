...
def zpperchatki():
    ...
    with col470:
        ...
        wa11 = float('{:.3f}'.format(wa11))
        ua11 = float('{:.3f}'.format(ua11))
        ya11 = float('{:.3f}'.format(ya11))
        va11 = float('{:.3f}'.format(va11))
        xa11 = float('{:.3f}'.format(xa11))
        ta11 = float('{:.3f}'.format(ta11))
        ...
        wb11 = float('{:.3f}'.format(wb11))
        ub11 = float('{:.3f}'.format(ub11))
        yb11 = float('{:.3f}'.format(yb11))
        vb11 = float('{:.3f}'.format(vb11))
        xb11 = float('{:.3f}'.format(xb11))
        tb11 = float('{:.3f}'.format(tb11))
