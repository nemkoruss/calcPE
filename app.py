...
x = st.sidebar.selectbox('Расчёт продукции:', ['Введение','Замес гранулы','Пленка','Пакеты','Бахилы','Перчатки', 'Заказ на бахилы', 'Очистить экран'])

y = st.sidebar.selectbox('Сотрудники:', ['Выбрать','Цех бахил','Цех экструзии', 'Цех перчаток','Цех пакетов', 'Очистить экран'])
